...
| VR99 Keyboard PCB | ![](assets/img/vr99-kb.png) | ● Direct key scanning *(no matrix)*<br>● Charliepixel per-key RGB | Open Source <br> [tecsmith/vr99-keyboard-pcb](https://github.com/tecsmith/vr99-keyboard-pcb) | <i class="text-danger fa-solid fa-traffic-light"></i> **UNDER DEVELOPMENT** <br> Design completed <br> NOT prototyped <br> NOT tested |
