...
| VR99 Keyboard PCB <br> *ft.* direct key <br> &nbsp; *(no matrix)* scanning | ![](https://cdn.jsdelivr.net/gh/tecsmith/vr99-keyboard-pcb@HEAD/docs/vr99-pcb-top.png) | Open Source <br> [tecsmith/vr99-keyboard-pcb](https://github.com/tecsmith/vr99-keyboard-pcb) | <i class="text-danger fa-solid fa-traffic-light"></i> **UNDER DEVELOPMENT** <br> Design compleated <br> NOT prototyped <br> NOT tested |
